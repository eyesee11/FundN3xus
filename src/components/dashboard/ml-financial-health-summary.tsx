...
export function MLFinancialHealthSummary() {
  const [healthData, setHealthData] = useState<FinancialHealthResponse | null>(null);
  ...
  const analyzeFinancialHealth = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e : new Error('Failed to analyze financial health'));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Get AI-powered insights into your financial health using machine learning analysis.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="text-center space-y-2">
              ...
              <div className="flex items-center justify-center gap-2">
                {(() => {
                  const Icon = getHealthCategoryIcon(healthData.health_category);
                  return <Icon className="w-5 h-5" />;
                })()}
                <Badge 
                  className={`${getHealthCategoryColor(healthData.health_category)} text-white`}
                >
        ...
        {isLoading && (
          <AIResponseCard 
            ...
            error={null}
            dataMap={[
              { key: 'health_score', label: 'Health Score', type: 'string', icon: 'summary' },
        ...
        {!healthData && !isLoading && !error && (
          <div className="text-center text-muted-foreground p-8 space-y-3">
            ...
            <div>
              ...
              <p className="text-sm">Click below to get your ML-powered financial health score.</p>
            </div>
          </div>
        )}
      </CardContent>
