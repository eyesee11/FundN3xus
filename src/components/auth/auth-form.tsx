...
export function AuthForm() {
  ...
  // Handle signup with password confirmation and validation
  ...
  return (
    <div className="w-full">
      <Card className="w-full border-border/50 bg-card/95 backdrop-blur-sm shadow-xl">
        <CardHeader className="text-center space-y-3">
          ...
          <CardDescription className="text-muted-foreground">
            Login or create your account to continue your financial journey
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Button 
            variant="outline" 
            type="button" 
            className="w-full border-border/50 bg-background/50 hover:bg-muted/50 transition-all duration-200"
          ...
          <Tabs defaultValue="login" className="w-full">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input 
                        ...
                        className="bg-background/50 border-border/50 focus:border-primary/50 pr-10 transition-colors"
            ...
            <TabsContent value="register" className="space-y-4">
               <form onSubmit={handleSignUp} className="space-y-4">
                <div className="space-y-4">
                   <div className="space-y-2">
                    <Label htmlFor="name-register" className="text-sm font-medium text-foreground">
                      Full Name
                    </Label>
                    <Input 
                      id="name-register" 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email-register" className="text-sm font-medium text-foreground">
                      Email Address
                    </Label>
                    <Input 
                      id="email-register" 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="password-register" className="text-sm font-medium text-foreground">
                      Password
                    </Label>
                    <div className="relative">
                      <Input 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirm-password-register" className="text-sm font-medium text-foreground">
                      Confirm Password
                    </Label>
                    <div className="relative">
                      <Input 
